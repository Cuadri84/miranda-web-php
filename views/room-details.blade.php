    ...
    <section class="main--detail">
      ...
      <div class="facilities__container">
        ...
        <div class="facilities__grid">
          ...
          <li class="facilitites__li">
            <img
              src="http://localhost/miranda-web-php/assets/amenities/key.png"
          ...
          <li class="facilitites__li">
            <img src="http://localhost/miranda-web-php/assets/amenities/kitchen.png" alt="Kitchen Facility" />
            <p>Kitchen</p>
          </li>
          <li class="facilitites__li">
            <img
              src="http://localhost/miranda-web-php/assets/amenities/lock.png"
          ...
          <li class="facilitites__li">
            <img src="http://localhost/miranda-web-php/assets/amenities/shower.png" alt="Shower Facility" />
            <p>Shower</p>
          </li>
          <li class="facilitites__li">
            <img
              src="http://localhost/miranda-web-php/assets/amenities/headphones.png"
          ...
          <li class="facilitites__li">
            <img src="http://localhost/miranda-web-php/assets/amenities/bed.png" alt="Single bed Facility" />
            <p>Single bed</p>
          </li>
          <li class="facilitites__li">
            <img
              src="http://localhost/miranda-web-php/assets/amenities/personpc.png"
              alt="Smart Security Facility"
            />
            <p>ExpertTeam</p>
          </li>
          <li class="facilitites__li">
            <img src="http://localhost/miranda-web-php/assets/amenities/shop.png" alt="Shop near Facility" />
            <p>Shop near</p>
          </li>
          <li class="facilitites__li">
            <img src="http://localhost/miranda-web-php/assets/amenities/towel.png" alt="Towels Facility" />
            <p>Towels</p>
          </li>
        </div>
      </div>
      ...
      <div class="guest-information">
        <div class="guest-img__container">
          <img src="http://localhost/miranda-web-php/assets/room-details/founder.jpg" alt="Guest Image" />
        </div>
      ...
      <div id="rooms__responisve">
        ...
        <div class="room-container">
          ...
          <img src="http://localhost/miranda-web-php/assets/rooms/room9.jpg" alt="Hotel Room" />
          <div class="room__information__container">
            <div>
              <h4>Economy Duplex</h4>
              <p>
